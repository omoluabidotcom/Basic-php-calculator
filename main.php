  ...
  <div class="container" id="container" >
   <fieldset class="field_container">
       ...
       <form name="form" method="GET"  >
        ...
        <input type="button" value="7" class="numb" id="seven" onclick="form.numberSpace.value+='7'" />
        ...
        <input type="button" value="4" class="numb" id="four" onclick="form.numberSpace.value+='4'" />
        ...
        <input type="button" value="1" class="numb" id="one" onclick="form.numberSpace.value+='1'" />
